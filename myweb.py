...
app.config['MAIL_USERNAME'] = 'eedriss67@gmail.com'
app.config['MAIL_PASSWORD'] = 'success247'
app.config['MAIL_DEFAULT_SENDER'] = 'eedriss67@gmail.com'
